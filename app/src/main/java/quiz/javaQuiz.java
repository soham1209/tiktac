...
public class javaQuiz extends AppCompatActivity {
    ...
    private ArrayList<javaQuizModel> quizModelArrayList;
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot users:snapshot.child("Java").getChildren()) {
                            ...
                            Toast.makeText(javaQuiz.this, "Start Quiz", Toast.LENGTH_SHORT).show();
    ...
    private void getQuizQuestion(ArrayList < javaQuizModel > quizModelArrayList) {
        quizModelArrayList.add(new javaQuizModel("Who invented Java Programming?", "Guido van Rossum", "James Gosling", "Dennis Ritchie", "Bjarne Stroustrup", "James Gosling"));
